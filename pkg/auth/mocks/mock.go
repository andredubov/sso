...
func (m *MockTokenManager) NewJWT(user model.User, app model.App, ttl time.Duration) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewJWT", user, app, ttl)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTokenManagerMockRecorder) NewJWT(user, app, ttl interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewJWT", reflect.TypeOf((*MockTokenManager)(nil).NewJWT), user, app, ttl)
}
...
func (m *MockTokenManager) Parse(accessToken string) (model.User, model.App, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Parse", accessToken)
	ret0, _ := ret[0].(model.User)
	ret1, _ := ret[1].(model.App)
	ret2, _ := ret[2].(error)
